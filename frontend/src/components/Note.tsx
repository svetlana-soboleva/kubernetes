...
Note = ({notes}) => {
  ...
  return (
    ...
    {
        notes.map((n) => (
          <div key={n.id} className="w-full h-64 flex flex-col justify-between bg-pink-200 dark:border-gray-700 rounded-lg border border-gray-400 mb-6 py-5 px-4">
          <div>
          ...
          <div>
              <div className="flex items-center gap-2 justify-between text-gray-800 dark:text-gray-100">
                  ...
                  <button className="w-8 h-8 cursor-pointer rounded-full bg-gray-700 text-white flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-offset-2  focus:ring-black" aria-label="edit note" role="button">
